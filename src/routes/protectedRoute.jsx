...
const ProtectedRoute = () => {
  ...
  const loggedInAccessible = ["/dashboard", "/dashboard-admin", "/content-management/FAQ/tambah-FAQ", "/content-management/FAQ/:id/edit-FAQ", "/user-management", "/user-management/detail", "/user-management/edit-user/:id", "/riwayat-transaksi", "/kelas", "/kelas/tambah-kelas", "/kelas/manage-kelas",  "/kelas/manage-kelas/manage-modul", "/kelas/tambah-modul", "/kelas/tambah-modul/tambah-tugas","/kelas/tambah-kuis", "/kelas/tambah-pertanyaan", "/kelas/manage-tugas", "/kelas/manage-tugas/review", "/kelas/manage-tugas/edit", "/edit-profile", "/faq"];

  // Halaman yang hanya bisa diakses oleh admin
  const adminAccessible = ["/dashboard-admin", "/content-management/FAQ/tambah-FAQ", "/content-management/FAQ/:id/edit-FAQ", "/user-management", "/user-management/detail", "/user-management/edit-user/:id", "/riwayat-transaksi", "/kelas", "/kelas/tambah-kelas", "/kelas/manage-kelas", "/kelas/tambah-modul", "/kelas/manage-kelas/manage-modul", "/kelas/tambah-modul/tambah-tugas","/kelas/tambah-kuis", "/kelas/tambah-pertanyaan", "/kelas/manage-tugas", "/kelas/manage-tugas/review", "/kelas/manage-tugas/edit", "/edit-profile", "/faq"];

  // Halaman yang hanya bisa diakses oleh instructor
  const instructorAccessible = ["/dashboard", "/kelas", "/kelas/tambah-kelas", "/kelas/manage-kelas",  "/kelas/manage-kelas/manage-modul", "/kelas/tambah-modul", "/kelas/tambah-modul/tambah-tugas","/kelas/tambah-kuis", "/kelas/tambah-pertanyaan", "/kelas/manage-tugas/review", "/kelas/manage-tugas","/kelas/manage-tugas/edit", "/edit-profile", "/faq"];
